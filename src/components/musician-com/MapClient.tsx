  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="text-center">
        ...
        <p className="mt-4 text-lg text-card-foreground">Loading musicians...</p>
      </div>
    </div>
  );
              ...
              >
                <div className="flex gap-3 items-center">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium text-card-foreground">{musician.name}</h3>
              ...
              <Popup className="min-w-[250px]">
                <Link href={`/musician/${musician._id}`} className="block">
                  <div className="flex gap-3">
                    ...
                    />
                    <div>
                      <h3 className="font-semibold text-card-foreground">{musician.name}</h3>
