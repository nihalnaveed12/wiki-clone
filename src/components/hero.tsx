...
export default function WikipediaHero() {
  ...
  const languages = [
    { name: "English", count: "6,974,000+ articles" },
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-white  text-black py-4 md:py-12 px-4">
      <div className=" w-full max-w-3xl  flex flex-col items-center">
        ...
        {!isMobile && (
          <>
            {/* Wikipedia Logo */}
            <h1 className="text-5xl font-serif tracking-wide mb-1 font-normal">WIKIPEDIA</h1>
            ...
            <div className="relative w-full h-[400px] mb-12">
              ...
              <div className="absolute left-1/2 top-56 transform -translate-x-1/2 -translate-y-1/2 z-10 w-[180px] h-[180px]">
                <Image src="/images/logo.png" alt="Wikipedia Globe" width={180} height={180} priority />
              </div>

              {/* English - Top Left */}
              <div  className="absolute top-[12%] left-[25%] z-20">
                <div  className="flex flex-col items-end">
                  <Link href={"/articles-page"} className="text-blue-700 hover:text-blue-500 hover:underline text-lg font-normal">
                    English
                  </Link>
              ...
              <div className="absolute top-[12%] right-[25%] z-20">
                <div className="flex flex-col items-start">
                  <a href="#" className="text-blue-700 hover:text-blue-500 hover:underline text-lg font-normal">
                    日本語
                  </a>
              ...
              <div className="absolute top-[30%] left-[18%] z-20">
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-sm text-gray-600">2 036 000+ статей</span>
                </div>
              </div>
              ...
              <div className="absolute top-[30%] right-[18%] z-20">
                <div className="flex flex-col items-start">
                  ...
                  <span className="text-sm text-gray-600">3,001,000+ Artikel</span>
                </div>
              </div>
              ...
              <div className="absolute top-[50%] left-[13%] z-20">
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-sm text-gray-600">2,021,000+ artículos</span>
                </div>
              </div>
              ...
              <div className="absolute top-[50%] right-[13%] z-20">
                <div className="flex flex-col items-start">
                  ...
                  <span className="text-sm text-gray-600">2,674,000+ articles</span>
                </div>
              </div>
              ...
              <div className="absolute top-[70%] left-[15%] z-20">
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-sm text-gray-600">1,470,000+ 条目 / 條目</span>
                </div>
              </div>
              ...
              <div className="absolute top-[90%] left-[28%] z-20">
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-sm text-gray-600">1,146,000+ artigos</span>
                </div>
              </div>
              ...
              <div className="absolute top-[88%] right-[28%] z-20">
                <div className="flex flex-col items-start">
                  ...
                  <span className="text-sm text-gray-600">1 652 000+ haseł</span>
                </div>
              </div>
            </div>
          ...
          <div className="w-full">
            ...
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 mr-3">
                <Image src="/images/logo.png" alt="Wikipedia Globe" width={48} height={48} priority />
              </div>
              <div>
                <h1 className="text-2xl font-serif tracking-wide font-normal">WIKIPEDIA</h1>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              {languages.map((lang, index) => (
                <div key={index} className="flex flex-col items-center text-center">
                  <a href="#" className="text-blue-400 hover:text-blue-300 hover:underline text-base font-normal">
                    {lang.name}
                  </a>
